        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-brand-light-text/80 font-secondary leading-relaxed">{t("subtitle")}</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              {!isSubmitted ? (
                ...
                <div className="p-4 bg-brand-gold/20 border border-brand-gold/30 rounded-lg">
                  <p className="text-brand-gold font-medium">{t("successMessage")}</p>
                </div>
              )}

              <p className="text-sm text-brand-light-text/50">{t("belowCta")}</p>
            </div>
          </div>
